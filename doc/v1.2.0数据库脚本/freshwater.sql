...
-- ----------------------------
INSERT INTO `freshwater_button` VALUES ('21fc1806579e84c6805188d66569863e', 1, 1, 'role-findByConditions', '分页查询', '922662ee6e440e14e7d947b5b2f6ed80', 'GET:/v1/roles/findByConditions', '2022-08-10 13:48:01', '2022-08-10 13:48:01');
...
-- ----------------------------
-- Table structure for freshwater_dynamic_table
-- ----------------------------
DROP TABLE IF EXISTS `freshwater_dynamic_table`;
CREATE TABLE `freshwater_dynamic_table`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键ID',
  ...
  `modify_time` datetime NOT NULL COMMENT '最后修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UKmff2mxrde3mvb303nvboiuiph`(`table_name`) USING BTREE,
  UNIQUE INDEX `UKwecode_dynamic_table_code`(`code`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '动态表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of freshwater_dynamic_table
-- ----------------------------

-- ----------------------------
-- Table structure for freshwater_dynamic_table_field
-- ----------------------------
DROP TABLE IF EXISTS `freshwater_dynamic_table_field`;
CREATE TABLE `freshwater_dynamic_table_field`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键ID',
  `table_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '动态表ID',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '字段名',
  `state` int NOT NULL COMMENT '状态,0:禁用,1:启用',
  `description` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '字段说明',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '字段类型',
  `show_type` int NOT NULL COMMENT '显示类型,1:文本,2图片,3:视频,4:时间,5:省市区,6:日期,7:码值,8:文本域,9:商品,10:url',
  `sort_index` int NOT NULL COMMENT '序号',
  `length` int NOT NULL COMMENT '长度',
  `nullable` bit(1) NOT NULL COMMENT '是否可以为null',
  `is_primary_key` bit(1) NOT NULL COMMENT '是否是主键',
  `is_unique` bit(1) NOT NULL COMMENT '是否是唯一',
  `editable` bit(1) NOT NULL COMMENT '是否可编辑',
  `is_list_view` bit(1) NOT NULL COMMENT '是否在列表上展示',
  `is_search` bit(1) NOT NULL COMMENT '是否加入搜索条件',
  `is_render_input` bit(1) NOT NULL COMMENT '是否渲染输入框',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `UKbwd771qfpj1cigatv6qh1f0xh`(`table_id`, `name`) USING BTREE,
  CONSTRAINT `FK6vk0q8r8phjufe3f8f8xqtjdd` FOREIGN KEY (`table_id`) REFERENCES `freshwater_dynamic_table` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of freshwater_dynamic_table_field
-- ----------------------------
...
-- ----------------------------
INSERT INTO `freshwater_role_button_mapping` VALUES ('9ebe0be07b80c891f62e44d613f51b6d', '44b8a58d8ee880e85649133a41bf33a1', '21fc1806579e84c6805188d66569863e');
INSERT INTO `freshwater_role_button_mapping` VALUES ('c1d43c4aee10c858856b0a9471670c03', '44b8a58d8ee880e85649133a41bf33a1', 'e3ea94e46549747d6d37095f3cb4fea2');
...
INSERT INTO `freshwater_role_menu_mapping` VALUES ('f076f72d889c540f5e8dfce1ce9f85ec', '44b8a58d8ee880e85649133a41bf33a1', '922662ee6e440e14e7d947b5b2f6ed80');
INSERT INTO `freshwater_role_menu_mapping` VALUES ('d0de3aa0062110f2d7e441caa1553f98', '44b8a58d8ee880e85649133a41bf33a1', 'b6f3e9e9a17f2236a311e7883f85a4c2');
INSERT INTO `freshwater_role_menu_mapping` VALUES ('5f2995e7ce528e43ee58d4498bdb96af', '44b8a58d8ee880e85649133a41bf33a1', 'c2c01dc2880affad1a4524f7426bd33d');
INSERT INTO `freshwater_role_menu_mapping` VALUES ('ad5464092202e19f27392c17feba825f', '44b8a58d8ee880e85649133a41bf33a1', 'dd9dd6278a0059c874f2aeb9f82403d1');
